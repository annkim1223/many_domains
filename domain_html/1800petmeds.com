...
<html lang="en">
<head>
<meta name="X-Yottaa-Metrics" content="33218cae0c7d/[20,-,-]" />
<meta name="X-Yottaa-Optimizations" content="ob/1000000000100001100 si/33118cae0dbf-1581699195-295037367 tts/1581630137809 ti/5b3fd3ca0b534453f080c43a ai/5b3fd3ca0b534453f080c3d1" />
...
<script type="text/javascript">yo_loader("https://www.1800petmeds.com/yo-app-sequencer.png?v=M4u3gsrq2KjoThbDD07ayKFCu_VDA3dK7RhuQqYM_XA4DYwtj3GEcPj4qLs80dBUkR-BMxR_zpqodNEs1k-gf0mWmTi_NT73ONfpJwjl0iJvHzUgUuKhSOY_GBegwSibPAmkr6DvrL8FSHvOwhIJRyoYkl-3vjMZ0FdbWQlRZbY=,e_XEssXbtlySSGT3mKkb3Z2zuJ_C_gy9kJcK4_B2YDRr-VkJ2IrRzz5qpHVW2V-yVCEGjGtQapD349ePJjOotio7qhe7gCgH90DL-pyWXX4=,xtBjmLZ__KiXGFdazvHoA1bNBntYZ3-jEifgznxf9uCv76zGZ-ZUM0usXa7gq4IMXmBpVUtI3HTPRnSrdlxI1ikM3Hw5gRII48RK91abh2EqXzrn9Zq-xoyO60KoWi1jTw6WIagazDrO0Xjy3VV341V9Su_JzFJAcEhQLlydgrdlVLpiynvBd4tTrMINnMSd,eSW-qPwUnMxZed_MArbhKwGwYepylmKaOJWz24tgSB1yA_zseQH0PJOUg7x9yRg1,s5sYAMWz2A4wKOBCI2fiyKYIHTcs0BZ6CgKP6rUm40dXgnuN3cewn19IOQrea6jq&t=Kb3G2cPgp-QWvCUKGaKNRg==&s=5c590eb7b016fb86c1fced5931fc487e");
...
<div class="site-header">
		<div class="inner">
			...
			<div class="right">
				...
				<form id="searchForm" action="/index.jsp;jsessionid=J0sAPGw69Iu2JKd3rU2uIhjH.prod2" class="search" method="GET"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input value="7128660115856936169" type="hidden"></input><div class="categories">
  ...
  <div id="ada-maincontent"></div>
		...
		<form id="searchFormM" action="/index.jsp;jsessionid=J0sAPGw69Iu2JKd3rU2uIhjH.prod2" class="input" method="GET"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input value="7128660115856936169" type="hidden"></input><input placeholder="Search" name="/1800petmeds/search/FacetSearchFormHandler.question" value="" type="text"><input name="_D:/1800petmeds/search/FacetSearchFormHandler.question" value=" " type="hidden"><button type="submit" title="Search" aria-label="Search"><span class="sr-only">Search</span></button>
...
<div class="top-bar" style="height:auto;">
    ...
    <div class="newsletter-signup-name"><strong>Subscribe for Special Offers!</strong></div>
      <form id="homeSignUpForm" name="customerInfo" action="/includes/customerInfo.jsp;jsessionid=J0sAPGw69Iu2JKd3rU2uIhjH.prod2?_DARGS=/includes/right_home_ncust_01.jsp" class="sign-up-form" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input value="7128660115856936169" type="hidden"></input><input name="/atg/userprofiling/ProfileFormHandler.emailSuccessURL" value="/email-thank-you.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.emailSuccessURL" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.emailErrorURL" value="/index.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.emailErrorURL" value=" " type="hidden"><input id="addButton" name="/atg/userprofiling/ProfileFormHandler.instantDiscountEmail" value="Submit" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.instantDiscountEmail" value=" " type="hidden"><div class="cols">
...
<span style="display:none" id="profilename">1629383714</span>
...
<div id="feedback-bar" class="feedback-bar">
  ...
  <div id="feedback_form_div" class="feedbackform">
    ...
    <form action="/includes/feedback-post.jsp" method="post" name="feedback_form" id="feedback_form">
        ...
        <input type="hidden" name="feedback_userid" id="feedback_userid" value="1629383714" />
        ...
        <input type="hidden" name="feedback_ipaddress" id="feedback_ipaddress" value="198.21.152.163" />
